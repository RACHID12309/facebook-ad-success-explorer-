        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-6">
              <li><Link to="/" className="hover:text-blue-200">الرئيسية</Link></li>
              <li><Link to="/search" className="hover:text-blue-200">بحث الإعلانات</Link></li>
              <li><Link to="/patterns" className="hover:text-blue-200">أنماط النجاح</Link></li>
            </ul>
          </nav>
